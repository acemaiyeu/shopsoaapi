...
class Gift extends Model
{
    ...
    public function details(){
        return $this->hasMany(GiftDetail::class)->select('id', 'gift_id', 'title');//->select('id','cart_id','theme_id','quantity','price','total_price','total_text','discount_price','discount_code');
    }
